...
def draw_sprite(frame, sprite, x_offset, y_offset):
    ...
    for c in range(3):
            ...
            sprite[:,:,c] * (sprite[:,:,2]/255.0) +  frame[y_offset:y_offset+h, x_offset:x_offset+w, c] * (1.0 - sprite[:,:,2]/255.0)
    return frame
...
def apply_sprite(image, path2sprite,w,x,y, angle, ontop = True):
    print("path2sprite",path2sprite)
    sprite = cv2.imread('D:\Virtual Wardrobe\Virtual-Dressing-Room-master\Project\images\Dress7\dress.png')
